...
/**
 * Created by qxx on 2017/5/30.
 */

public class AdpFav_Adp extends BaseAdapter{
    private Context context;
    private List<Map<String, Object>> list;
    private LayoutInflater inflater;

    public AdpFav_Adp(Context context, List<Map<String, Object>> list) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.fav_one_list, null);
        ...
        viewHolder.title.setText((position+1)+"、"+titleStr);
